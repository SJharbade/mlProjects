...
if __name__=="__main__":
    obj = DataIngestion()
    logging.info ("After Object")
    train_data, test_data = obj.initate_data_ingestion()
    logging.info ("After Object initation") 

    data_transformation = DataTransformation()
    logging.info ("After data transformation declaration")
    data_transformation.initiate_data_transformation(train_data,test_data)
    logging.info ("After data transformation initation")